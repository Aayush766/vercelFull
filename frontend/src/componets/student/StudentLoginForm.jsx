        ...
        <div className="w-full rounded-xl shadow-xl border border-blue-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/90 backdrop-blur-md p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="text-center mt-4">
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); setShowForgotPasswordModal(true); }} // Open modal on click
                className="text-sm text-blue-600 hover:text-blue-800 dark:text-yellow-400"
              >
                Forgot Password?
              </a>
            </div>
